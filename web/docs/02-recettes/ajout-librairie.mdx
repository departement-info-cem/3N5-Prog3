...
- si tu as besoin d'un autre format (Gradle ou Gradle Short), copie le code dans l'onglet correspondant
- faire un CTRL+C pour copier la ligne qui commence par `implementation ...`

## Etape 2 : Ajouter la librairie dans le fichier `build.gradle.kts` ou `build.gradle`

- ouvrir le projet dans l'environnement de développement (IntelliJ, Android Studio, etc.).
- ouvrir le fichier build.gradle.kts ou build.gradle
