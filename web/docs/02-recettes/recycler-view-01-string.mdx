...
<Tabs queryString="Liste-string">
  ...
  <TabItem value="items" label="items">
    ...
    <TabItem value="item" label="item">
      Une fois notre LazyColumn en place, nous allons avoir 2 fonctions importantes à comprendre.
      - `items`: Cette fonction permet de créer une liste d'éléments à afficher dans la LazyColumn.
      - `item`: Cette fonction permet de créer un élément unique à afficher dans la LazyColumn.
