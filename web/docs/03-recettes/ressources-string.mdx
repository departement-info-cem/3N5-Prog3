...
Il est aussi parfois requis d'utiliser ces ressources string pour certaines fonctionnalités, comme le multilingue, et le [tiroire de navigation](./tiroir.mdx).
