...
<TabItem value="nav_header.xml" label="nav_header.xml">
  ...
  Dans l'image plus haut, l'en-tête est composé du texte "Bievenue sur votre tiroir" et de "57 + 23 = 80".
...
<TabItem value="MainActivity.kt" label="MainActivity.kt">
  ...
  Il faut maintenant lier tout les éléments ensemble, dans **chaque activités** où on veut afficher un tiroir. 
