...
- <Highlight color="tip">1 point</Highlight> Suppression de tous les votes "Suppr. les votes". On doit retourner à la liste des sujets si on y est pas déjà.
- <Highlight color="tip">1 point</Highlight> Suppression de toutes les sujets "Suppr. les sujets". On doit retourner à la liste des sujets si on y est pas déjà.
