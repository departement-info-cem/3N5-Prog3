...
- Présentation du **[deuxièeme travail](../tp/tp2)**.
...
fun lireFichier(){
    ...
    // highlight-next-line
	// Question : Catch on laisse l'erreur se propager?
}
```
...
fun main(args: Array<String>){
	val maList: List<Integer>  = Arrays.asList(1, 2, 3, 4, 5)
	val lists: List<List<Int> >  = Lists.partition(maList, -1)
