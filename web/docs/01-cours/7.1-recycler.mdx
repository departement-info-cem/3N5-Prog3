...
- Consulter et implémenter ces 3 recettes : 
  - [RecyclerView - String](../02-recettes/recycler-view-01-string.mdx)
  - [RecyclerView - Objet](../02-recettes/recycler-view-02-objet.mdx)
  - [RecyclerView - Activités](../02-recettes/recycler-view-03-activite.mdx)
- Commencer les exercices. Arrêtez-vous quand vous aurez complété 2 heures.

<Video url="https://www.youtube.com/watch?v=QZXPolzcWLA" />

[Code après la vidéo](https://github.com/departement-info-cem/3N5-Prog3/tree/main/code/VideoRecyclerView)
...
![Album Favoris : Base](_7.1-recycler/albums_favoris_base.png)
...
![Albums favoris : Classe](_7.1-recycler/albums_favoris_classe.png)
...
![Albums favoris : Détails](_7.1-recycler/albums_favoris_details.png)
...
![Albums favoris : Supprimer](_7.1-recycler/albums_favoris_supprimer.png)
...
![Alpha](_7.1-recycler/ordre_alpha.png)
...
![Duplicata](_7.1-recycler/duplicata.png)
...
![Albums favoris : Supprimer](_7.1-recycler/albums_favoris_finition_item.png)

</Column>
<Column size="3" >

![Albums favoris : Supprimer](_7.1-recycler/albums_favoris_finition_details.png)
...
![Albums favoris : Glisser début](_7.1-recycler/albums_favoris_glisser_debut.png)
...
![Albums favoris : Glisser fin](_7.1-recycler/albums_favoris_glisser_fin.png)
