...
Une librairie complète fournissant une base de données SQLite avec Room et ses méthodes est fournie sur **[Site de la librairie](https://jitpack.io/#departement-info-cem/3N5-TP3-Librairie-BD)**.
...
- Le [repo et le code source](https://github.com/departement-info-cem/3N5-TP3-Librairie-BD) pour les curieux
